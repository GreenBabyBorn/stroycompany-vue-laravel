<template>
    <header class="header">
        <div class="header__container">
            ...
            <router-link  @click="menuActive" to="/admin/dashboard" class="header__logo logo">
            ...
            <div :class="{'_menu-open': menuOpen}" class="header__menu menu">
                <nav class="menu__body">
                    <ul class="menu__list" @click="menuActive">
                        ...
                        <!--                        </li>-->
                        <li class="menu__item">
                            <router-link class="menu__link" to="/">На сайт</router-link>
                        </li>
                        <li class="menu__item">
                            <router-link class="menu__link" to="/admin/projects">Проекты и этапы</router-link>
                        </li>
                        <li class="menu__item">
                            <router-link class="menu__link" to="/admin/reviews">Отзывы</router-link>
                        </li>
                        <li class="menu__item">
                            <button @click.prevent="logout" class="menu__link menu__link_red">Выйти</button>
                            <!--                            <router-link class="menu__link" to="/contacts">Контакты</router-link>-->
                        </li>
                    </ul>
                </nav>
                <button :class="{'_menu-open': menuOpen}" @click.prevent="menuActive" type="button" class="icon-menu">
                    <span></span></button>
            </div>
